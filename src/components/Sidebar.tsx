        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center pt-8 pb-6 px-4 relative">
                    ...
                    {/* Logo SVG - Diperbesar dan di tengah */}
                    <div className="relative mb-4 group">
                        ...
                        <div className="relative transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-2 group-hover:drop-shadow-2xl">
                            <img
                                src={logo}
                                alt="GISTEX Logo"
                                className={`${isOpen ? 'w-36 h-28' : 'w-12 h-12'} object-contain drop-shadow-2xl filter brightness-110 transition-all duration-300`}
                            />
                        </div>
                    </div>

                    <div className={`text-center space-y-1 transform transition-all duration-300 ${!isOpen ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100'}`}>
                        <h2 className="text-yellow-400 font-bold text-sm tracking-wider drop-shadow-lg hover:text-yellow-300 transition-colors">
                            PT GISTEX
                        </h2>
                        <h2 className="text-yellow-400/90 font-bold text-xs tracking-widest drop-shadow-md hover:text-yellow-300/90 transition-colors">
                            GARMENT INDONESIA
                        </h2>
                    </div>
                </div>
                ...
                >
                    ...
                    <Link
                        to="/home"
                        className={`group relative flex items-center ${isOpen ? 'justify-start gap-3 px-4' : 'justify-center'} py-4 rounded-xl transition-all duration-300 font-semibold text-base overflow-hidden min-h-[56px] ${location.pathname === '/home' || location.pathname === '/'
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Text dengan efek */}
                            {isOpen && (
                                <span className="transition-all duration-300 font-bold tracking-wide flex-1">{'HOME'}</span>
                            )}
                        </div>
                    </Link>
                    ...
                    <div className="space-y-1">
                        ...
                        <Link
                            to="/monitoring-rfid"
                            className={`group relative flex items-center ${isOpen ? 'justify-start gap-3 px-4' : 'justify-center'} py-4 rounded-xl transition-all duration-300 font-semibold text-base overflow-hidden min-h-[56px] ${isRFIDPage
                                ? 'text-white bg-white/25 shadow-xl shadow-white/20 border-l-4 border-yellow-400'
                                : 'text-white/80 hover:text-white hover:bg-white/15 hover:shadow-lg hover:shadow-white/10 border-l-4 border-transparent hover:border-yellow-400/50'
                                }`}
                        >
                            ...
                            >
                                ...
                                {/* Text */}
                                {isOpen && (
                                    <span className="transition-all duration-300 font-bold tracking-wide flex-1 text-left">{'RFID'}</span>
                                )}
                            </div>
                        </Link>
                                ...
                                {isLinePage && currentLineData && (
                                    ...
                                    >
                                        ...
                                        {!isProductionLinesPage && (
                                            <Link
                                                to="/monitoring-rfid"
                                                className="group relative flex items-center justify-start gap-3 px-4 py-2.5 rounded-md transition-all duration-300 font-medium text-xs overflow-hidden min-h-[40px] w-full text-white/60 hover:text-white hover:bg-white/8 border-l-2 border-transparent hover:border-yellow-400/40"
                                            >
                                        ...
                                        <Link
                                            ...
                                            className={`group relative flex items-center justify-start gap-3 px-4 py-2.5 rounded-md transition-all duration-300 font-medium text-xs overflow-hidden min-h-[40px] w-full ${location.pathname === `/line/${currentLineId}`
                                            ...
                                            (location.pathname === '/data-rfid' && currentLineId === '1')) && (
                                                <div className="ml-4 space-y-1">
                                                    ...
                                                    {currentLineId === '1' && (
                                                        <Link
                                                            to="/daftar-rfid"
                                                            className={`group relative flex items-center justify-start gap-3 px-4 py-2.5 rounded-md transition-all duration-300 font-medium text-xs overflow-hidden min-h-[40px] w-full ${location.pathname === '/daftar-rfid'
                                                    ...
                                                    <Link
                                                        ...
                                                        className={`group relative flex items-center justify-start gap-3 px-4 py-2.5 rounded-md transition-all duration-300 font-medium text-xs overflow-hidden min-h-[40px] w-full ${location.pathname === `/dashboard-rfid/${currentLineId}`
                    ...
                    <Link
                        to="/about-us"
                        className={`group relative flex items-center ${isOpen ? 'justify-start gap-3 px-4' : 'justify-center'} py-4 rounded-xl transition-all duration-300 font-semibold overflow-hidden min-h-[56px] ${location.pathname === '/about-us'
                            ? 'text-white bg-white/25 shadow-xl shadow-white/20 border-l-4 border-yellow-400'
                            : 'text-white/80 hover:text-white hover:bg-white/15 hover:shadow-lg hover:shadow-white/10 border-l-4 border-transparent hover:border-yellow-400/50'
                            }`}
                    >
                        ...
                        >
                            ...
                            {/* Text dengan efek */}
                            {isOpen && (
                                <span className="transition-all duration-300 font-bold tracking-wide flex-1 text-left">{'ABOUT US'}</span>
                            )}
                        </div>
                    </Link>
                </nav>
                ...
                <div className={`px-4 py-2 transition-all duration-300 ${!isOpen ? 'opacity-0' : 'opacity-100'}`}>
                    <div className="h-[1px] bg-gradient-to-r from-transparent via-white/40 to-transparent w-full shadow-lg shadow-white/20"></div>
                </div>
                ...
                {isOpen && (
                    <div className="px-4 py-4">
                        ...
                        <div className="text-white/70 font-bold uppercase tracking-widest mb-4 px-2 flex items-center justify-center">
                            <span className="text-lg text-center">TEAMS</span>
                        </div>
                        <div className="space-y-2.5">
                            {/* Bagian dari API */}
                            <div className="group relative flex items-center justify-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-all duration-300 cursor-pointer border border-transparent hover:border-blue-400/30 hover:shadow-lg hover:shadow-blue-400/20">
                                <div className="relative">
                                    <div className="w-3 h-3 rounded-full bg-blue-400 shadow-lg shadow-blue-400/70 flex-shrink-0 group-hover:scale-125 group-hover:shadow-blue-400 transition-all duration-300 animate-pulse"></div>
                                    <div className="absolute inset-0 w-3 h-3 rounded-full bg-blue-400/30 blur-md group-hover:blur-lg transition-all duration-300"></div>
                                </div>
                                <span className="text-white/90 text-lg font-semibold group-hover:text-white transition-colors tracking-wide text-center">
                ...
                {/* Spacing antara TEAMS dan LOGOUT */}
                {isOpen && (
                ...
                <div className={isOpen ? 'p-4' : 'p-2'}>
                    ...
                    >
                        ...
                        {/* Glow effect */}
                        <div className="absolute inset-0 bg-red-500/20 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
                        ...
                        {/* Text dengan efek - diperbesar */}
                        {isOpen && (
                            <span className="relative z-10 flex-1 text-left transition-all duration-300 font-bold tracking-wider text-xl">{'LOGOUT'}</span>
                        )}
                    </button>
                </div>
            </aside>
